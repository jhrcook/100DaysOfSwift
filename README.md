...
**Day 27 - July 1, 2019:** I started and completed the main portion of project 5, the "Word Scramble" game app. There I learned about requesting user input and boolean logic. I also went a bit further and defined structures to control the failure messages for the user.